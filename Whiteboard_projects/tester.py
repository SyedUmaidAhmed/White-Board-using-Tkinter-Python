...
from tkinter.colorchooser import askcolor #No idea yet

import tkinter as tk

root = Tk()
root.title("White Board")
root.geometry("1050x570") #+150+50at end means ?

root.configure(bg="#f2f3f5")


root.resizable(False,False) #size fixed
